...
export default function CardProd({ id, nomeprod, preço, imagem }) {
  ...
  return (
    <div className="border border-gray-300 bg-gray-50 rounded-sm p-3 w-96 h-96 sm:w-96 sm:h-80 md:w-70 md:h-90 flex flex-col items-center shadow-md hover:shadow-xl transition duration-300 hover:scale-105">
